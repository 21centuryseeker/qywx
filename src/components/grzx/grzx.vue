<template>
  <div class="bgFFF"  style="height: 100%;overflow-y: scroll;">
    <div class="header_top" v-if="flagNum==1">
        <div class="header_title">
          ...
          <div class="my_content">
            <div class="baseInfo">
              <h5>{{name}}</h5>
              <p v-if='flagJB'>教职工号 {{num}}</p>
            </div>

            <div class="mylist">
                <ul>
                  <li class="clearfix">
                    <div class="list-row-lable">
                      <i class="iconfont icon_yellow">&#xe6d6;</i>
                      性别
                    </div>
                    <div class="list-row-box ">{{sex}}</div>
                  </li>
                  <li class="clearfix">
                    <div class="list-row-lable">
                      <i class="iconfont icon_blue">&#xe678;</i>
                      手机号
                    </div>
                    <div class="list-row-box ">
                      {{iphone}}
                       <a href="javascript:void(0)" @click="$router.push({path: '/edit_phone'})"  size="large"> <i class="iconfont icon_gray">&#xe6b3;</i></a>
                    </div>
                  </li>
                  <li class="clearfix">
                    <div class="list-row-lable">
                      <i class="iconfont icon_orange">&#xe605;</i>
                      邮箱
                    </div>
                    <div class="list-row-box ">
                      {{email}}
                      <a href="javascript:void(0)"  @click="$router.push({path: '/edit_email'})" > <i class="iconfont icon_gray">&#xe6b3;</i></a>
                    </div>
                  </li>
                </ul>
            </div>
    ...
    <!-- 显示手机号 -->
    <div class="editas" v-else-if="flagNum==2">
      ...
      <ul>
        ...
        <li class="buttonGroup clearfix">
          <mt-button plain  class="btn"  @click="changeFlag(1)">取 消</mt-button>
          <mt-button  class="floatR" @click="edit_sure">确 定</mt-button>
        </li>
      </ul>
    </div>

    <div class="editas" v-else>
      <div class="title">编辑邮箱</div>
      <ul>
        <li>
          <input type="email" v-model="newEmil" placeholder="请输入邮箱" :class="flagKong?'red':''" />
        </li>
        <li class="code-box clearfix">
           <input type="text" v-model="emailCode" placeholder="验证码" :class="flagKongCode?'red':''" />
           <mt-button  :disabled="disabledFlagEmil" @click="getEmailCode">{{codemsgEmill}}</mt-button>
        </li>
        <li class="buttonGroup clearfix">
          <mt-button plain   class="btn"  @click="changeFlag(1)">取 消</mt-button>
          <mt-button  class="floatR"  @click="edit_sureEmil">确 定</mt-button>
        </li>
      </ul>
    </div>
